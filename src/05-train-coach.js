...
export function findPassenger(passengers, name) {
  ...
  return passengers.find((passengers) => passengers.name.toLowerCase() === name.toLowerCase());
}
...
export function getPassengerIndex(passengers, name) {
  ...
  return passengers.findIndex((passengers) => passengers.name.toLowerCase() === name.toLowerCase());
}
...
export function isAnyWaitlisted(passengers) {
  ...
  return passengers.some(passengers => passengers.status.toLowerCase() === "waitlisted");
}
...
export function areAllConfirmed(passengers) {
  ...
  return passengers.every(passengers => passengers.status.toLowerCase() === "confirmed");
}
...
export function getWaitlistedPassengers(passengers) {
  ...
  return passengers.filter(passengers => passengers.status.toLowerCase() === "waitlisted");
}
